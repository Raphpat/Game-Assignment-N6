...
public class TileMap {
	 ...
	 * @return The Image object associated with the tile at position 'x,y', null if
	 *         blank or not found
	 */
	...
	/**
	 * Get the top left pixel x coordinate of a tile at position 'x,y' in the tile
	 * map
	 * 
	 * @param x The x tile coordinate (in tiles, not pixels)
	 * @param y The y tile coordinate (in tiles, not pixels)
	 * @return The top left pixel x coordinate of a tile at position 'x,y' in the
	 *         tile map
	 */
	...
	/**
	 * Get the top left pixel y coordinate of a tile at position 'x,y' in the tile
	 * map
	 * 
	 * @param x The x tile coordinate (in tiles, not pixels)
	 * @param y The y tile coordinate (in tiles, not pixels)
	 * @return The top left pixel y coordinate of a tile at position 'x,y' in the
	 *         tile map
	 */
